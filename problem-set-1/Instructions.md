**This problem set is actually from the MIT OCW 6.00SC course, rather than the MIT edX 6.00 course, but since the coursework was so similar, I decided to include them here as well**
